    ...
    opts = {
        ...
        custom_highlights = function(color)
            return {
                ...
                ["@lsp.typemod.class.globalScope.c"] = {
                    fg = color.cyan,
                    bold = false,
                },
                ...
                ["@lsp.typemod.enum.globalScope.c"] = {
                    fg = color.cyan,
                    bold = false,
                },
